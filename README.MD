...
**Readiness Controller** is a lightweight Kubernetes operator that implements **Global Dependency Gating**.
...
3.  Ensure the `conditionType` matches exactly what you defined in the controller config.
